...
class UserProfileTest extends \OmegaUp\Test\ControllerTestCase {
    ...
    public function testStatsWithYearFilter() {
        ...
        $this->assertTrue($found2021InFiltered, 'Year 2021 filtered heatmap should contain entries from 2021');
        $this->assertFalse($found2022InFiltered, 'Year 2021 filtered heatmap should not contain entries from 2022');
        ...
        $this->assertFalse($found2021In2022Filtered, 'Year 2022 filtered heatmap should not contain entries from 2021');
        $this->assertTrue($found2022In2022Filtered, 'Year 2022 filtered heatmap should contain entries from 2022');
        $this->assertEquals(2, $count2022, 'Should count exactly 2 submissions in 2022');
    }
